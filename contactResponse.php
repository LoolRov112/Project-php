...
<head>
    ...
    <script>
        ...
        function submitReply() {
            ...
            // Send the reply to the server using AJAX or a form submission
            console.log(`Reply for ID ${id}: ${reply}`);
            closePopup();
        }
    </script>
</head>
<body dir="rtl">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-container">
                                    <form method="POST" action="contactResponse.php" style="display:inline;">
    ...
    <div id="popup" class="popup">
        <h3>הכנס תגובה</h3>
        <textarea id="reply-text" rows="4" placeholder="כתוב תגובה כאן..."></textarea>
        <input type="hidden" id="reply-id">
        <button onclick="submitReply()">שלח</button>
